...
public class ProductController {
	...
	public Map<String, Object> getChulgoList() {
		...
		chulgo.setSdate("2024-02-01 00:00:00");
		chulgo.setEdate("2024-02-20 23:59:59");		
	...
	public Map<String, Object> getJaegoStatusList() {
		...
		jaego.setSdate("2024-02-01 00:00:00");
		jaego.setEdate("2024-02-20 23:59:59");
	...
	public Map<String, Object> getChulgoWaitingList() {
		...
		Chulgo chulgo = new Chulgo();
		chulgo.setSdate("2024-02-01 00:00:00");
		chulgo.setEdate("2025-02-20 23:59:59");
	...
	public Map<String, Object> getWorkStatusList() {
		...
		gongjung.setSdate("2024-02-01 00:00:00");
		gongjung.setEdate("2024-02-20 23:59:59");
		...
		for(int i=0; i<workStatusList.size(); i++) {
			...
			gongjung.setSdate("2024-02-01");
			gongjung.setEdate("2024-02-20");			
			gongjung.setOrd_code(workStatusList.get(i).getOrd_code());
			List<Gongjung> rowData = productService.getWorkStatusListGongjungSum(gongjung);
			for(Gongjung gongjungSum : rowData) {
				if("A".equals(gongjungSum.getIlbo_gubn())) {
					rowMap.put("prod_a", gongjungSum.getIlbo_su());	
				}else if("J".equals(gongjungSum.getIlbo_gubn())) {
					rowMap.put("prod_j", gongjungSum.getIlbo_su());	
				}else if("P".equals(gongjungSum.getIlbo_gubn())) {
					rowMap.put("prod_p", gongjungSum.getIlbo_su());	
				}else if("H".equals(gongjungSum.getIlbo_gubn())) {
					rowMap.put("prod_h", gongjungSum.getIlbo_su());	
				}else if("F".equals(gongjungSum.getIlbo_gubn())) {
					rowMap.put("prod_f", gongjungSum.getIlbo_su());	
				}else if("R".equals(gongjungSum.getIlbo_gubn())) {
					rowMap.put("prod_r", gongjungSum.getIlbo_su());	
				}else if("S".equals(gongjungSum.getIlbo_gubn())) {
					rowMap.put("prod_s", gongjungSum.getIlbo_su());	
				}
			}
